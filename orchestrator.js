...
const SYSTEM_PROMPT = `You are an AI session manager for a WhatsApp-based coding assistant. Your job is to understand the user's intent and decide what action to take.
